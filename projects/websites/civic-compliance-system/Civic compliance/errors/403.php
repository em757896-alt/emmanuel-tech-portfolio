<?php
$pageTitle = 'Access Denied - PBO Kenya';
...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 800; background: linear-gradient(135deg,#ef4444,#dc2626); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
...
<body>
    <div class="error-page">
        <div class="error-card">
            ...
            <p class="error-desc">You don't have permission to access this page. Please contact your administrator if you believe this is a mistake.</p>
